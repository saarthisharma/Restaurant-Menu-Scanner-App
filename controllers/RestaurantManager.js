...
// signup
const restaurantManagerSignup = async(req,res)=>{
    try {
        ...
        // setting restaurantManager type
...
const restaurantManagerLogin=async(req,res)=>{
    try {
...
const restaurantManagerLogout = async(req,res)=>{
    try {
...
const restaurantManagerForgotPassword = async(req,res)=>{
    try {
...
module.exports = {
    ...
    restaurantManagerLogin,
    restaurantManagerLogout,
    restaurantManagerForgotPassword,
    restaurantManagerResetPassword
}